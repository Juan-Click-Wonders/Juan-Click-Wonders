...
urlpatterns = [
    ...
    path('products/update/<int:product_id>/', ProductDetailApi.as_view(), name='product_update'),
    path('products/delete/<int:product_id>/', ProductDetailApi.as_view(), name='product_delete'),
    path("products/<int:product_id>/stock/", ProductStockStatusApi.as_view(), name="product_stock_status"),
